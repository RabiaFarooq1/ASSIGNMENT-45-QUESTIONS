...
let message: string = "hello ${rabia}, what are you doing these days?"; 
console.log (message)
...
let Personname: string = "rabia farooq";
...
let messagge: string = famous_person + 'once said, "Work, work and work"';
...
let names: string []= [ "rabia","laiba","nida","bisma"];
...
const guestCantMakeIt: string = "Charlie";
...
let usernames:string[]=["admin","rabia","abdullah","mahnoor","aiza","fiza","laiba"];
...
//current users 
let current_users:string[]=["rabia90","laiba56","bisma23","nida12","fiza45"];
//new users 
let new_users:string[]=["rabia90","laiba45","nida33","faiza44","saba77"];
...
//favourite pizza
let favourite_pizza:string[]=["fajita","tikka","mushroom"];
//using for loop
...
function makeGreat(originalMagicians: string[]): string[] {
  ...
  function showmagicians(magicians: string[], greatMagicians: string[]) {
